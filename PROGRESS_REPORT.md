...
- **Backend (Jest):** 30 тестовых сьютов, **194 теста passing** (100% успех).
- **Frontend (Vitest):** 13 тестовых сьютов, **70 тестов passing** (100% успех).
- **Всего автоматических тестов:** **264 теста passing**.
...
12. **Разделение метрик ожидания YML-фида и ошибок данных в экспорте Prom.ua (TASK-41):**
    - 🟢 Завершено и успешно развернуто на сервере Hetzner (`188.245.254.12`, `https://liman.terrace.pp.ua`): Строгая классификация ошибок Prom.ua `POST /products/edit_by_external_id`: отделение `id: Продукт не найден` (ожидают импорта через YML-фид) от реальных ошибок данных/валидации.
