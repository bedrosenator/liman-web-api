...
12. **Разделение метрик ожидания YML-фида и ошибок данных в экспорте Prom.ua (TASK-41):**
    - ✅ Выполнено и готово к деплою на Hetzner: Строгая классификация ошибок Prom.ua `POST /products/edit_by_external_id`: отделение `id: Продукт не найден` (ожидают импорта через YML-фид) от реальных ошибок данных/валидации.
