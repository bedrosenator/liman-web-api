...
- [x] **[TASK-26]** Динамическое название магазина Хорошоп и прямой экспорт каталога в 1 клик:
  ...
  - Корректный маппинг штрихкода в системный атрибут `gtin` и парсинг логов Хорошопа с разделением предупреждений шаблона (код 11) и фатальных ошибок (код 7);
  - Модальное окно `HoroshopExportModal.tsx` с выбором режимов выгрузки, состава полей, селектором категорий и живым прогресс-баром;
  - Успешно развернуто и верифицировано на продакшн-сервере Hetzner (10/10 SKU выгружено без ошибок).
